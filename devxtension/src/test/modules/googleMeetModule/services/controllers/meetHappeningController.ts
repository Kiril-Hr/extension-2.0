import { GoogleMeetIsTakingPlace } from '../../types/googleMeetInterfaces';
...
import {dependencyContainer, Feature, ServiceDecorator} from "../../../../../core";
...
export class MeetHappeningController implements GoogleMeetIsTakingPlace{
  ...
  constructor(
    ...
    public MainFunctionsService= dependencyContainer.getService<typeof GoogleMeetMainFunctionsService>(GoogleMeetMainFunctionsService.name),
    public ConditionService= dependencyContainer.getService<typeof GoogleMeetConditionService>(GoogleMeetConditionService.name),
    ...
    public FullScreenService= dependencyContainer.getService<typeof GoogleMeetFullScreenService>(GoogleMeetFullScreenService.name),
    public RuleService= dependencyContainer.getService<typeof GoogleMeetEventRuleService>(GoogleMeetEventRuleService.name),
  ) {}
